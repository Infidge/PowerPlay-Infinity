...
public class Auto_Left extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        positionRobot = drive.trajectoryBuilder(startPose, true)
                .lineToLinearHeading(new Pose2d(-85,-40, -Math.toRadians(7) - 0.244978663))
                .build();
        positionRobot2 = drive.trajectoryBuilder(positionRobot.end(), true)
                .lineToLinearHeading(new Pose2d(-95,-53, -Math.toRadians(7) - 0.244978663))
                .build();
                ...
                case choosePark:
                    if (parkZone == 3){
                        park = drive.trajectorySequenceBuilder(positionRobot.end())
                                .lineToConstantHeading(new Vector2d(-85,-30))
                                .lineToConstantHeading(new Vector2d(-20,-30))
                                .build();
                    }
                    else if (parkZone == 2){
                        park = drive.trajectorySequenceBuilder(positionRobot.end())
                                .lineToConstantHeading(new Vector2d(-87,-30))
                                .build();
                    }
                    else
                        park = drive.trajectorySequenceBuilder(positionRobot.end())
                                .lineToConstantHeading(new Vector2d(-85,-30))
                                .lineToConstantHeading(new Vector2d(-180,-30))
                                .build();
                    programstage = nextStage();
